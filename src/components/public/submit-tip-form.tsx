      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-zinc-500 text-sm mb-6 leading-relaxed">
            Thank you for your report. Our team will review it and verify from credible sources
            before any publication. Your identity is protected.
          </p>
          <div className="flex gap-3 justify-center">
            <Link
              href="/"
              className="bg-[#1a1a2e] text-white px-5 py-2.5 rounded-lg text-sm font-medium"
            >
              Return Home
            </Link>
            <button
    ...
    <div className="min-h-screen bg-white">
      <nav className="glass-nav fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <Link
            href="/login"
            className="text-sm bg-[#1a1a2e] text-white px-3 py-1.5 rounded-lg font-medium"
          >
            Sign In
          </Link>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-6 pt-28 pb-16">
        <div className="mb-8">
          ...
          <p className="text-zinc-500 leading-relaxed">
            Have information about election-related violence? Submit a confidential tip. All reports
            are reviewed by our team before publication. Your identity is never disclosed.
          </p>
        </div>

        <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 mb-6">
          <p className="text-xs text-blue-700 leading-relaxed">
            <strong>Do no harm:</strong> Do not include names, photos, or identifying details of
            victims or witnesses. Only submit information you believe to be true. All tips are
            verified against credible sources before any publication.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-400 mt-0.5">
                  We will not store any identifying information about you
                </div>
              </div>
            </label>
            ...
            {!form.isAnonymous && (
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1">
                  Only used if we need to verify details. Never shared publicly.
                </p>
              </div>
            )}
          </div>
          ...
          <button
            ...
            className="w-full bg-[#1a1a2e] text-white py-3 rounded-xl text-sm font-medium hover:bg-[#16213e] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
